                    ...
                    <form>                      
                        <div className="grid grid-cols-2 grid-rows-7 gap-4 mt-[32px]">
                            <div>
                                ...
                                <input type="text" id="first_name" className="block w-full border border-slate-400 text-sm rounded-lg p-2.5" placeholder="" required />
                            </div>
                            <div>
                                <label htmlFor="last_name" className="block mb-2 text-[16px] font-medium text-black">Last Name</label>
                                <input type="text" id="last_name" className="block w-full border border-slate-400 text-sm rounded-lg p-2.5" placeholder="" required />
                            </div>
                            <div className="col-span-2 ">
                                <div>
                                    <label htmlFor="email" className="block mb-2 text-[16px] font-medium text-black">Email Address</label>
                                    <input type="text" id="email" className="block w-full border border-slate-400 text-sm rounded-lg p-2.5" placeholder="" required />
                                </div>
                            </div>
                            ...
                            <div className="row-start-3">
                                <div className="flex items-center ps-4 border border-slate-400 rounded bg-white">
                                    <input id="bordered-radio-2" type="radio" value="" name="bordered-radio" className="w-4 h-4 "/>
                            ...
                            <div className="col-span-2 row-span-2 ">
                                <div>
                                    ...
                                    <textarea id="message" rows="5" className="block w-full border border-slate-400 text-sm rounded-lg p-2.5" placeholder=""></textarea>
                                </div>
                            </div>
                            <div className="col-span-2 row-start-6 mt-[20px]">
                                <input checked id="checked-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded" />
                            ...
                            <div className="col-span-2 row-start-7 h-[58px]  ">
                                <button type="button" className="block w-full text-white bg-green-600 font-medium rounded-lg text-sm px-5 py-2.5 h-[58px] ">Submit</button>
                            </div>
                        </div>                       
                    </form>
            </div>
